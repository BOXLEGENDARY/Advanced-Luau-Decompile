...
local Highlight = (isfile and loadfile and isfile("Highlight.lua") and loadfile("Highlight.lua")()) or loadstring(game:HttpGet("https://raw.githubusercontent.com/BOXLEGENDARY/ZxLDeX/refs/heads/main/Highlight.lua"))()
...
newButton("Hi",function()
    return "Joins The Simple Spy Discord"
end,
function()
    setclipboard("Made By ZxL ( ZDH Group )")
    TextLabel.Text = "Copied invite to your clipboard"
    if request then
        request({Url = 'http://127.0.0.1:6463/rpc?v=1',Method = 'POST',Headers = {['Content-Type'] = 'application/json', Origin = 'https://discord.com'},Body = http:JSONEncode({cmd = 'INVITE_BROWSER',nonce = http:GenerateGUID(false),args = {code = 'Null'}})})
    end
end)
...
if configs.supersecretdevtoggle then
    ...
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/BOXLEGENDARY/ZxLDeX/refs/heads/main/SimpleSpy2.lua"))()
    end)
    newButton("Load SSV3",function()
        return "Load's Simple Spy V3"
    end,
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/BOXLEGENDARY/ZxLDeX/refs/heads/main/SimpleSpy3.lua"))()
    end)
